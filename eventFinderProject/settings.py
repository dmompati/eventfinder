...
DATABASES = {
    'default': {
        ...
        'USER': 'dessiemompati', # enter your user name here
        'PASSWORD': 'Tuesday_24',
        'HOST': 'localhost',
        'PORT': '5432',
    }
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #where files will be uploaded located on the base directory of project
MEDIA_URL = '/media/'
